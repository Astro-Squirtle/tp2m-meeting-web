...
const AGENDA_DATA = {
  "Day 1": {
    ...
    weekday: "Monday",
    events: [
      { time: "-", task: "Science Meetings (Details Coming Soon)", speaker: "-" },
    ]
  },
  "Day 2": {
    date: "Aug 25",
  ...
  "Day 3": {
    ...
    weekday: "Wednesday",
    events: [
      { time: "-", task: "TP2m partner meetings (Details Coming Soon)", speaker: "-" },
    ]
  },
  "Day 4": {
    date: "Aug 27",
  ...
  "Day 5": {
    ...
    weekday: "Friday",
    events: [
      { time: "-", task: "Cultural excursion (Details Coming Soon)", speaker: "-" },
    ]
  }
};
